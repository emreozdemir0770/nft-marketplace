...
const IconNavigationContainer = styled.div(() => [
  tw`rounded-full relative bg-gradient-to-r from-gray-background-icon-1 to-gray-background-icon-2 cursor-pointer outline-none border-none h-12 w-12 flex-shrink-0 flex justify-center items-center overflow-hidden`,
]);
