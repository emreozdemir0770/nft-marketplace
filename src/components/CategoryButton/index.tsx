...
const Button = styled.label(({ isActive }: { isActive: boolean }) => [
  tw`flex items-center border-2 cursor-pointer border-white border-opacity-0 text-white text-base font-normal py-2 pr-6 w-full justify-center rounded-3xl leading-loose bg-white bg-opacity-5 relative hover:bg-white hover:bg-opacity-10`,
